            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead nota="el nombre no dice la caja">Versión (como la escribe Cars)</TableHead>
                  <TableHead className="text-right" nota="facturadas sin caja conocida">Unidades {anio}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {sinCaja.map((x) => (
