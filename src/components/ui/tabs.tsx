  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // Píldora activa: bg-card (blanco de tile), no bg-background (el
        // lienzo gris del bento) — si no, la píldora "flotante" sobre el
        // riel se fundía con el fondo y no se veía ninguna selección.
        "data-active:bg-card data-active:text-foreground data-active:shadow-[0_1px_2px_oklch(0.2_0.03_257/6%),0_2px_6px_-2px_oklch(0.2_0.05_260/12%)] dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground dark:data-active:shadow-none",
